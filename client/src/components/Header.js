            ...
            <header>
                <div className="row">
                    ...
                    <Nav className="justify-content-center">
                        ...
                        <Nav.Item>
                            <Nav.Link href="/newpet" style={{ color: "var(--platinum)"}}><div className= "bi d-flex justify-content-center mx-auto mb-1"><MdPets style={{fontSize: "2.5rem", color: "var(--platinum)"}} /></div>
                                ADD NEW PET
                            </Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link href="/newvetvisit" style={{ color: "var(--platinum)"}}><div className= "bi d-flex justify-content-center mx-auto mb-1"><MdLocalHospital style={{fontSize: "2.5rem", color: "var(--platinum)"}} /></div>
                                ADD NEW VET VISIT
                            </Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
